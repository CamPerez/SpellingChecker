...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#5a1fca2e#;
   ...
   u00052 : constant Version_32 := 16#5e196e91#;
   pragma Export (C, u00052, "ada__containersS");
   u00053 : constant Version_32 := 16#af50e98f#;
   pragma Export (C, u00053, "ada__stringsS");
   u00054 : constant Version_32 := 16#75de1dee#;
   pragma Export (C, u00054, "ada__strings__hashB");
   u00055 : constant Version_32 := 16#3655ad4c#;
   pragma Export (C, u00055, "ada__strings__hashS");
   ...
   u00069 : constant Version_32 := 16#28f088c2#;
   pragma Export (C, u00069, "ada__text_ioB");
   u00070 : constant Version_32 := 16#1a9b0017#;
   ...
   u00075 : constant Version_32 := 16#8bb5f2c0#;
   pragma Export (C, u00075, "interfaces__c_streamsS");
   u00076 : constant Version_32 := 16#845f5a34#;
   pragma Export (C, u00076, "system__crtlS");
   u00077 : constant Version_32 := 16#431faf3c#;
   pragma Export (C, u00077, "system__file_ioB");
   u00078 : constant Version_32 := 16#53bf6d5f#;
   pragma Export (C, u00078, "system__file_ioS");
   u00079 : constant Version_32 := 16#b7ab275c#;
   pragma Export (C, u00079, "ada__finalizationB");
   u00080 : constant Version_32 := 16#19f764ca#;
   ...
   u00082 : constant Version_32 := 16#bb3cffaa#;
   pragma Export (C, u00082, "system__finalization_rootS");
   u00083 : constant Version_32 := 16#ee0f26dd#;
   pragma Export (C, u00083, "system__os_libB");
   u00084 : constant Version_32 := 16#d7b69782#;
   pragma Export (C, u00084, "system__os_libS");
   u00085 : constant Version_32 := 16#1a817b8e#;
   pragma Export (C, u00085, "system__stringsB");
   u00086 : constant Version_32 := 16#8a719d5c#;
   pragma Export (C, u00086, "system__stringsS");
   u00087 : constant Version_32 := 16#09511692#;
   pragma Export (C, u00087, "system__file_control_blockS");
   u00088 : constant Version_32 := 16#80fc1570#;
   pragma Export (C, u00088, "diccionari_hsB");
   u00089 : constant Version_32 := 16#f53969c2#;
   pragma Export (C, u00089, "diccionari_hsS");
   u00090 : constant Version_32 := 16#a48ede19#;
   pragma Export (C, u00090, "diccionari_tr_memoryB");
   u00091 : constant Version_32 := 16#75a5bec3#;
   pragma Export (C, u00091, "diccionari_tr_memoryS");
   u00092 : constant Version_32 := 16#c66da672#;
   pragma Export (C, u00092, "pparaulaB");
   u00093 : constant Version_32 := 16#f87856ed#;
   pragma Export (C, u00093, "pparaulaS");
   u00094 : constant Version_32 := 16#1e347caa#;
   pragma Export (C, u00094, "ada__wide_wide_charactersS");
   u00095 : constant Version_32 := 16#5d655666#;
   pragma Export (C, u00095, "ada__wide_wide_characters__handlingB");
   u00096 : constant Version_32 := 16#0910a976#;
   pragma Export (C, u00096, "ada__wide_wide_characters__handlingS");
   u00097 : constant Version_32 := 16#37434769#;
   pragma Export (C, u00097, "ada__wide_wide_characters__unicodeB");
   u00098 : constant Version_32 := 16#fb9c164a#;
   pragma Export (C, u00098, "ada__wide_wide_characters__unicodeS");
   u00099 : constant Version_32 := 16#27ccf663#;
   pragma Export (C, u00099, "system__utf_32B");
   u00100 : constant Version_32 := 16#6a4765f6#;
   pragma Export (C, u00100, "system__utf_32S");
   u00101 : constant Version_32 := 16#2b70b149#;
   pragma Export (C, u00101, "system__concat_3B");
   u00102 : constant Version_32 := 16#ffbed09f#;
   pragma Export (C, u00102, "system__concat_3S");
   u00103 : constant Version_32 := 16#fd83e873#;
   pragma Export (C, u00103, "system__concat_2B");
   u00104 : constant Version_32 := 16#f66e5bea#;
   pragma Export (C, u00104, "system__concat_2S");
   u00105 : constant Version_32 := 16#2b93a046#;
   pragma Export (C, u00105, "system__img_charB");
   u00106 : constant Version_32 := 16#68fad4dd#;
   pragma Export (C, u00106, "system__img_charS");
   u00107 : constant Version_32 := 16#96eb4d5b#;
   pragma Export (C, u00107, "diccionari_simpleB");
   u00108 : constant Version_32 := 16#477995e7#;
   pragma Export (C, u00108, "diccionari_simpleS");
   u00109 : constant Version_32 := 16#b1628d02#;
   pragma Export (C, u00109, "diccionari_trB");
   u00110 : constant Version_32 := 16#0a9b8ee6#;
   pragma Export (C, u00110, "diccionari_trS");
   u00111 : constant Version_32 := 16#932a4690#;
   pragma Export (C, u00111, "system__concat_4B");
   u00112 : constant Version_32 := 16#8aaaa71a#;
   pragma Export (C, u00112, "system__concat_4S");
   u00113 : constant Version_32 := 16#276453b7#;
   pragma Export (C, u00113, "system__img_lldB");
   u00114 : constant Version_32 := 16#07ec8553#;
   pragma Export (C, u00114, "system__img_lldS");
   u00115 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00115, "system__img_decB");
   u00116 : constant Version_32 := 16#5ae385e1#;
   pragma Export (C, u00116, "system__img_decS");
   u00117 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00117, "system__img_lliB");
   u00118 : constant Version_32 := 16#e581d9eb#;
   pragma Export (C, u00118, "system__img_lliS");
   u00119 : constant Version_32 := 16#2bce1226#;
   pragma Export (C, u00119, "system__memoryB");
   u00120 : constant Version_32 := 16#adb3ea0e#;
   ...
   --  diccionari_tr%s
   --  diccionari_tr%b
   --  diccionari_tr_memory%s
   --  diccionari_tr_memory%b
   --  diccionari_hs%s
   --  diccionari_hs%b
   --  main%b
